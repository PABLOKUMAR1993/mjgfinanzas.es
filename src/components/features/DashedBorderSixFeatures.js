...
export default () => {
  ...
  const cards = [
    ...
    { imageSrc: PlanificacionFinanciera, title: "Planificación Financiera" },
    { imageSrc: CreacionPatrimonio, title: "Creación de Patrimonio" },
    { imageSrc: Jubilacion, title: "Jubilación" },
    { imageSrc: EducacionDinanciera, title: "Educación Financiera" },
  ];
  ...
  return (
    <Container>
      <ThreeColumnContainer>
        <Heading>
          ¿Que <span tw="text-primary-500">puedo hacer</span> por tí?
        </Heading>
        {cards.map((card, i) => (
          <Column key={i}>
            <Card>
