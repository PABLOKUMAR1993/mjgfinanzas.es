...
export default ({
  ...
  description = (
    <>
      <p>
        Te pido un favor que puede solucionar tu futuro.<b> Toma consciencia de
        estas preguntas</b> y responde de forma realista y seria:
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        ayuda a domicilio. <b>¿Tendrás suficiente dinero?</b>
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Si quieres llegar a <b>tu jubilación de lujo</b>, con la calidad que te
